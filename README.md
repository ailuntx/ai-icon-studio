...
<img src="plugins/ai-icon-studio/assets/logo.png" width="128" alt="AI Icon Studio — Color wing">
...
品牌：ailuntz · https://www.ailuntz.com。公共插件版本：0.1.2。使用说明与脚本包含在插件内，无需 npm 安装。

已发布到官方目录，分类为 Creativity：[安装 AI Icon Studio](https://chatgpt.com/plugins/plugins_6aa19a8879108191825af4fe2523aee3) · [下载发布包](https://github.com/ailuntx/ai-icon-studio/releases/tag/v0.1.2)。
