...
You may install and use the distributed plugin and its bundled scripts for your own authorized design workflows. Other rights in the software remain reserved unless separately granted. Third-party software and services remain subject to their own terms.

You are responsible for having permission to use project files and reference images, choosing whether to send them to a generation provider, and reviewing generated artwork before integrating or publishing it. The plugin does not guarantee that generated artwork is unique, protectable, free of third-party rights, or suitable for a particular brand.
